...
const CONFIG = {
  ...
  STARTER_HERO_TITLE_1: '一人公司不需要什么都会，而是懂得用工具放大专业', // 英雄区文字
  STARTER_HERO_TITLE_2: '从工具中获得力量，找到生活的掌控感', // 英雄区文字
  // 英雄区两个按钮，如果TEXT留空则隐藏按钮
  STARTER_HERO_BUTTON_1_TEXT: '开始感受', // 英雄区按钮
  STARTER_HERO_BUTTON_1_URL:
    'https://docs.tangly1024.com/article/vercel-deploy-notion-next', // 英雄区按钮
  STARTER_HERO_BUTTON_2_TEXT: '在WeChat上关注', // 英雄区按钮
  ...
  STARTER_CONTACT_EMAIL_TEXT: 'lmcha528@gmail.com',
