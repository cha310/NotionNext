...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '叉', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一人公司不需要什么都会，而是懂得用工具放大专业。从工具中获得力量，找到生活的掌控感。”', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://achahca.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'CHA,AI,blog,notion', // 网站关键词 英文逗号隔开
