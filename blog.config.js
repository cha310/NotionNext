...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '阿叉', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '推动世界变得更好的起点，是让自己先变得更好。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://achacha.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'cha, achacha, acha, blog, Notion, 博客', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    '我坚信：推动世界变得更好的起点，是让自己先变得更好。当你善用科技与工具，高效解决问题，解放专注力，你能以原来一半的时间完成任务——省下的，是真正属于生活、探索和成长的宝贵时光。',
